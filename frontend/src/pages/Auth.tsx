    ...
    <div className="auth-page">
      ...
      <style>{`
        ...
        .hero-eyebrow {
          ...
          color: #facc15; margin-bottom: 20px;
          text-shadow: 0 0 20px rgba(250,204,21,0.5);
        }
        ...
        .hero-title {
          ...
          font-size: clamp(52px, 5.8vw, 88px);
          font-weight: 300; line-height: 0.95;
          color: #f7f0df; letter-spacing: -2.2px; margin: 0 0 6px;
        }
        .hero-title span {
          display: block;
          color: #f5d020; font-style: italic;
          text-shadow: 0 0 35px rgba(250,204,21,0.65), 0 0 90px rgba(250,204,21,0.28);
          animation: goldGlow 2.8s ease-in-out infinite alternate;
        }
        ...
        .hero-subtitle {
          margin-top: 16px;
          font-family: 'DM Mono', monospace; font-size: 12px; line-height: 1.85;
        ...
        .primary-cta:hover { transform: translateY(-1px); box-shadow: 0 0 44px rgba(255,220,0,0.5), 0 6px 28px rgba(250,204,21,0.28); }

        .secondary-cta {
          padding: 12px 28px; border-radius: 3px;
          background: transparent; border: 1px solid rgba(250,204,21,0.28);
          font-family: 'DM Mono', monospace; font-size: 9px; letter-spacing: 2.5px;
          color: #facc15; cursor: pointer; text-transform: uppercase;
          transition: all 0.2s;
        }
        .secondary-cta:hover { background: rgba(250,204,21,0.07); border-color: rgba(250,204,21,0.55); transform: translateY(-1px); }

        .hero-disclaimer {
          margin-top: 20px;
          font-family: 'DM Mono', monospace; font-size: 9px; line-height: 1.7;
          color: rgba(255,255,255,0.22); letter-spacing: 0.3px; max-width: 460px;
        }

        /* ── AUTH PANEL (right column card) ── */
        .auth-panel {
          width: 380px; flex-shrink: 0; align-self: center;
        }
        ...
        .auth-title {
          ...
          font-size: 11px; letter-spacing: 3px; color: #facc15;
        ...
        .auth-switch {
          ...
          border: 1px solid rgba(250,204,21,0.15); border-radius: 3px; overflow: hidden;
        }
        .auth-switch button {
          flex: 1; padding: 8px;
        ...
        .auth-switch button:not(.active):hover { color: rgba(255,255,255,0.6); background: rgba(255,255,255,0.03); }
        ...
        .auth-field label {
          font-family: 'DM Mono', monospace; font-size: 7.5px; letter-spacing: 3px;
        ...
        .auth-field input::placeholder { color: rgba(255,255,255,0.17); }

        /* Legal checkbox */
        .auth-legal-check {
          display: flex; align-items: flex-start; gap: 10px;
          font-family: 'DM Mono', monospace; font-size: 9.5px; line-height: 1.6;
          color: rgba(255,255,255,0.38); cursor: pointer;
        }
        .auth-legal-check input[type="checkbox"] { margin-top: 3px; accent-color: #facc15; flex-shrink: 0; }
        .auth-legal-check a { color: rgba(250,204,21,0.75); text-decoration: none; }
        .auth-legal-check a:hover { color: #facc15; }

        /* Errors / success */
        .auth-error {
          font-family: 'DM Mono', monospace; font-size: 9.5px; line-height: 1.55;
          padding: 9px 11px; border-radius: 3px;
          background: rgba(220,38,38,0.14); border: 1px solid rgba(248,113,113,0.35); color: #fecaca;
          margin: 0;
        }
        .auth-success {
          font-family: 'DM Mono', monospace; font-size: 9.5px; line-height: 1.55;
          padding: 9px 11px; border-radius: 3px;
          background: rgba(22,163,74,0.14); border: 1px solid rgba(74,222,128,0.35); color: #bbf7d0;
          margin: 0;
        }
        ...
        .auth-submit:hover { opacity: 0.93; transform: translateY(-1px); box-shadow: 0 0 44px rgba(255,220,0,0.5); }
        .auth-submit:disabled { opacity: 0.55; cursor: default; transform: none; }

        /* Footer text + disclaimer */
        .auth-footer-text {
          text-align: center; margin-top: 14px;
          font-family: 'DM Mono', monospace; font-size: 9.5px; color: rgba(255,255,255,0.28);
        }
        .auth-footer-text span { color: rgba(250,204,21,0.7); cursor: pointer; }
        .auth-footer-text span:hover { color: #facc15; }

        .auth-disclaimer {
          margin-top: 16px; padding-top: 14px;
          border-top: 1px solid rgba(255,255,255,0.06);
          font-family: 'DM Mono', monospace; font-size: 8.5px; line-height: 1.7;
        ...
        .nav-cta:hover { background: rgba(250,204,21,0.12) !important; box-shadow: 0 0 16px rgba(250,204,21,0.2); }
        ...
        .section-eyebrow {
          font-family: 'DM Mono', monospace; font-size: 8.5px; letter-spacing: 5px;
          color: rgba(250,204,21,0.85); text-transform: uppercase;
          text-shadow: 0 0 16px rgba(250,204,21,0.42);
        ...
        .section-heading h2 {
          ...
          color: #f7f0df; letter-spacing: -1.2px; line-height: 0.97; margin: 0 0 20px;
        }
        .section-heading p {
          font-family: 'DM Mono', monospace; font-size: 12.5px; line-height: 2;
        ...
        .detail-block h4 {
          font-family: 'DM Mono', monospace; font-size: 7.5px; letter-spacing: 3px;
          color: rgba(250,204,21,0.9); margin: 0 0 9px; text-transform: uppercase;
          text-shadow: 0 0 12px rgba(250,204,21,0.45);
        }
        .detail-block p {
          font-family: 'DM Mono', monospace; font-size: 11.5px; line-height: 1.82;
        ...
        .about-section {
          padding: 110px 56px;
          background: radial-gradient(ellipse at 50% 0%, rgba(250,204,21,0.07), transparent 70%), #050608;
          font-family: 'Syne', sans-serif;
        }
        ...
        .about-content h2 {
          ...
          color: #f7f0df; line-height: 0.97; letter-spacing: -1.2px; margin: 0 0 24px;
        }
        .about-content > p {
          font-family: 'DM Mono', monospace; font-size: 12.5px; line-height: 2;
          color: rgba(255,255,255,0.43); margin: 0 auto; max-width: 720px;
        }
        .about-points {
        ...
        .about-points span {
          font-family: 'DM Mono', monospace; font-size: 9px; letter-spacing: 2.5px;
          color: rgba(250,204,21,0.75);
          border: 1px solid rgba(250,204,21,0.2); padding: 8px 18px; border-radius: 2px;
          background: rgba(250,204,21,0.04);
        }
        ...
        .contact-section {
          padding: 80px 56px;
          background: #030405; border-top: 1px solid rgba(250,204,21,0.1);
        }
        .contact-card {
        ...
        .contact-card h2 {
          font-family: 'Cormorant Garamond', serif;
          font-size: clamp(38px, 4.5vw, 64px); font-weight: 300;
          color: #f7f0df; line-height: 0.97; letter-spacing: -1.2px; margin: 0 0 20px;
        }
        .contact-card > p {
          font-family: 'DM Mono', monospace; font-size: 12px; line-height: 2;
          color: rgba(255,255,255,0.4); margin: 0 auto 36px; max-width: 600px;
        }
        ...
        .social-links a:hover { color: #facc15; border-color: rgba(250,204,21,0.4); background: rgba(250,204,21,0.06); }
        ...
        .legal-footer-links a:hover { color: rgba(250,204,21,0.7); }
        ...
        @media (max-width: 980px) {
          .hero-content { flex-direction: column; padding: 20px 24px 10px; gap: 24px; overflow-y: auto; }
          .hero-section { height: auto; min-height: 100vh; }
          .auth-panel { width: 100%; max-width: 420px; align-self: flex-start; }
          .features-grid { grid-template-columns: repeat(2, 1fr); }
          .detail-grid { grid-template-columns: 1fr; }
          .about-section, .contact-section { padding-left: 24px; padding-right: 24px; }
        }
        @media (max-width: 640px) {
          .hero-content { padding: 16px 20px 8px; }
          .hero-title { font-size: clamp(40px, 12vw, 58px); letter-spacing: -1.3px; }
          .hero-actions { flex-direction: column; }
          .primary-cta, .secondary-cta { width: 100%; text-align: center; }
          .features-grid { grid-template-columns: 1fr; }
          .about-section, .contact-section { padding-left: 20px; padding-right: 20px; }
