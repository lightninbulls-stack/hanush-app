                    ...
                    {stocks.map((stock) => (
                        ...
                        >
                            ...
                            <div className="return-col">
                                <span className={`return-badge ${(stock.return_1w ?? 0) >= 0 ? "positive" : "negative"}`}>
                                    {stock.return_1w ?? 0}%
                                </span>
                            </div>

                            <div className="return-col">
                                <span className={`return-badge ${(stock.return_1m ?? 0) >= 0 ? "positive" : "negative"}`}>
                                    {stock.return_1m ?? 0}%
                                </span>
                            </div>

                            <div className="return-col">
                                <span className={`return-badge ${(stock.return_3m ?? 0) >= 0 ? "positive" : "negative"}`}>
                                    {stock.return_3m ?? 0}%
                                </span>
                            </div>

                            <div className="return-col">
                                <span className={`return-badge ${(stock.return_6m ?? 0) >= 0 ? "positive" : "negative"}`}>
                                    {stock.return_6m ?? 0}%
                                </span>
                            </div>
                ...
                <div className="table-body">
                    {stocks.map((stock) => (
                        ...
                        >
                            ...
                            <div className="return-col">
                                <span className={`return-badge ${(stock.return_3m ?? 0) >= 0 ? "positive" : "negative"}`}>
                                    {(stock.return_3m ?? 0) >= 0 ? "▲" : "▼"} {Math.abs(stock.return_3m ?? 0)}%
                                </span>
                            </div>

                            <div className="return-col">
                                <span className={`return-badge ${(stock.return_6m ?? 0) >= 0 ? "positive" : "negative"}`}>
                                    {(stock.return_6m ?? 0) >= 0 ? "▲" : "▼"} {Math.abs(stock.return_6m ?? 0)}%
                                </span>
                            </div>
                        </div>
                    ))}
